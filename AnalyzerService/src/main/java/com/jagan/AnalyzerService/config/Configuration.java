package com.jagan.AnalyzerService.config;
...
public class Configuration {
	...
	public static final String CONSUMER_TOPIC_NAME = "dataAnalyzer";
	public static final String PRODUCER_ELASTIC_TOPIC_NAME = "elastic";
	public static final String PRODUCER_PERSISTENCE_TOPIC_NAME = "persistence";
	public static final String PRODUCER_STATS_TOPIC_NAME = "statistics";
